...
%       run('tools/buildLibraries.m')
    ...
    buildSubsystem(libName, 'Common Utilities', { ...
        ...
        struct('Name','Excitation Signal Generator','System','ddc.common.ExcitationSignalGenerator'), ...
    });
    ...
    ufcBlocks = { ...
        ...
        struct('Name','Unfalsified Switching Controller','System','ddc.ufc.UnfalsifiedSwitchingController'), ...
        struct('Name','Multimodal Switching Controller',  'System','ddc.ufc.MultimodelSwitchingController'), ...
    };
...
function buildUfcMaskedSubsystem(libName)
    ...
    set_param(bankBlk, 'Controllers', 'Controllers');
    ...
    set_param(swBlk, 'Controllers', 'Controllers');
    ...
    add_line(ssName, 'y/1', 'Switching Logic/2');
    ...
    mask.Description = sprintf(['Ready-to-use unfalsified adaptive switching control ' ...
        ...
        'switching logic, pre-wired. Set Controllers to the candidate controllers ' ...
        'as a tf array or a vector of proportional gains.']);
    p = mask.addParameter('Type', 'edit', 'Prompt', 'Candidate controllers', ...
        'Name', 'Controllers', 'Value', '[0.5; 1; 2]');
